...
namespace CW_Ekran_Görüntüsü_Aracý
{
    ...
    public partial class Form1 : Form
    {
        ...
        bool upload = false;
        int siteindex = 0;
        public Form1(int gecikme,bool upload,int index)
        {
        ...
        public void SaveSelection(bool showCursor)
        {
            ...
            if (ScreenPath != "" || ScreenShot.saveToClipboard)
            {
                ...
                ScreenShot.CaptureImage(showCursor, curSize, curPos, StartPoint, Point.Empty, bounds, ScreenPath, fi,upload,siteindex);
